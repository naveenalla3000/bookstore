            ...
            <tbody>
              <?php foreach ($allCategories as $category) : ?>
                <tr>
                  ...
                  <td><a href="<?php echo ADMINURL; ?>/categories-admins/update-category.php?id=<?php echo $category->id; ?>
                " class="btn btn-warning text-white text-center ">Update </a></td>
                  <td><a href="
                <?php echo ADMINURL; ?>/categories-admins/delete-category.php?id=<?php echo $category->id; ?>
